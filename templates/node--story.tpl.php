<div id="node-<?php print $node->nid; ?>" class="basic-content <?php print $classes; ?>">
	...
	<?php
	$sidebarCount = 0;	
	foreach ($field_cover_image as $entry) {
	...
	<div class="sidebar-images">
		<div class="sidebar-images-container"><?php
	foreach ($field_cover_image as $entry) {
    ...
    <?php } ?>
      ...
      ?><p><a href="/stories">&raquo; Read more stories from funded organisations</a></p>
      <?php  
		if (isset($field_full_image)) { ?>
		<div class="fullwidth-images fullwidth-images-with-sidebar">
